 ...
 */
function get_icon( $icon, $size = 24 ) {
	return junique_SVG_Icons::get_svg( 'ui', $icon, $size );
}
...
function get_social_icon_svg( $icon, $size = 24 ) {
	return junique_SVG_Icons::get_svg( 'social', $icon, $size );
}
...
function get_social_link_svg( $uri, $size = 24 ) {
	return junique_SVG_Icons::get_social_link_svg( $uri, $size );
}
